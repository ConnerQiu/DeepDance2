...
from utils.pose import load_amc_file, interpolated_traj
import pickle
import argparse
import glfw
...
model_file = f'C:/Users/cq/PycharmProjects/RFC/khrylib/assets/mujoco_models/{args.model_file}.xml'
model = load_model_from_path(model_file)
sim = MjSim(model)
body_qposaddr = get_body_qposaddr(model)
amc_file = f'C:/Users/cq/PycharmProjects/RFC/data/cmu_mocap/amc/{args.amc_id}.amc'
cyclic = False
cycle_offset = 0.0
offset_z = 0.0
...
expert_traj_file = f'C:/Users/cq/PycharmProjects/RFC/data/cmu_mocap/motion/{args.out_id}.p'
